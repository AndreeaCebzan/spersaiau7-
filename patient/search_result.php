...
<!-- result -->
					...
					$sql = " SELECT * FROM doctors_list WHERE speciality_ids = '" . $_POST["medical_speciality"]."' ";
					...
					if($count>=1){
						...
						while($row=mysqli_fetch_array($result)){
								...
								echo "<td>".$row['speciality_ids']."</td>";
								
						?>
							<td><a href="booking.php?doc_id=<?php echo $row['id'] ?>">Book</a></td>;
						<?php 		
