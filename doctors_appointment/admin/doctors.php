				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="name_pref" placeholder="DR." required="">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="" class="control-label">Nr. contact</label>
							...
							<div class="form-group">
								<label for="" class="control-label">Parolă</label>
								<input type="password" class="form-control" name="password" >
							</div>
							<div class="form-group">
								<label for="" class="control-label">Imagine</label>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">
								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3"> Salvare</button>
								<button class="btn btn-sm btn-default col-sm-3" type="button" onclick="_reset()">Anulare</button>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	$('#manage-doctor').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp==1){
					alert_toast("Adăugat cu succes",'success')
					setTimeout(function(){
						location.reload()
					},1500)
					...
					$('#msg').html('<div class="alert alert-danger">Email există deja.</div>')
					end_load()
				}
			}
		})
	...
	$('.delete_doctor').click(function(){
		_conf("Eșt sigur că dorești să ștergi acest doctor?","delete_doctor",[$(this).attr('data-id')])
	})
