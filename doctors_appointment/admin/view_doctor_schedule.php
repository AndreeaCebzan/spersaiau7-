...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row">
			<table class="table table-striped table-bordered">
				<thead>
					<tr>
						<th class="text-center">Ziua</th>
						<th class="text-center">Orar</th>
					</tr>
				</thead>
				<tbody>
	...
	<hr>
		<div class="row">
			<button class="btn btn-primary btn-sm col-md-3 mr-2" type="button" id="edit">Modifică</button>
			<button class="btn btn-secondary btn-sm col-md-3  " type="button" data-dismiss="modal" id="">Anulare</button>
		</div>
	</div>
</div>
<script>
