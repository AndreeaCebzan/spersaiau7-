		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					<label for="name" class="control-label">Nume sistem</label>
				...
				<div class="form-group">
					<label for="about" class="control-label">Despre</label>
				...
				<center>
					<button class="btn btn-info btn-primary btn-block col-md-2">Salvare</button>
				</center>
			</form>
		</div>
	</div>
	...
	$('#manage-settings').submit(function(e){
		...
		$.ajax({
			...
			success:function(resp){
				if(resp == 1){
					alert_toast('Salvat cu succes.','success')
					setTimeout(function(){
						location.reload()
					},1000)
				}
