...
$res=mysqli_query($conn,"SELECT * FROM users WHERE username=".$usersession);
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end mb-4 page-title">
                    	<h3 class="text-white">Doctori</h3>
        ...
        <div class="container">
        	<div class="card">
        			...
        			<div class="col-lg-12">
						...
						<div class="row">
							<div class="col-md-12 text-center">
								...
								?>
								<h2><b>Doctor cu specilizarea în  <?php echo $s ?></b></h2>
							</div>
						</div>
						<hr class="divider">
						<?php endif; ?>
				...
				<div class="row align-items-center">
					...
					<div class="col-md-6">
						 <p>Nume: <b><?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?></b></p>
						 ...
						 <p><small><a href="javascript:void(0)" class="view_schedule" data-id="<?php echo $row['id'] ?>" data-name="<?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?>"><i class='fa fa-calendar'></i> Orar</a></b></small></p>
						 <p><b>Specializări</b></p>
					...
					<div class="col-md-3 text-center align-self-end-sm">
						<button class="btn-outline-primary  btn  mb-4 set_appointment" type="button" data-id="<?php echo $row['id'] ?>"  data-name="<?php echo "Dr. ".$row['name'].', '.$row['name_pref'] ?>">Programează-te</button>
					</div>
				</div>
    ...
    <script>
       ...
       $('.set_appointment').click(function(){
       	if('<?php echo isset($_SESSION['login_id']) ?>' == 1)
			uni_modal("Setează o programare la  "+$(this).attr('data-name'),"set_appointment.php?id="+$(this).attr('data-id'),'mid-large')
		else{
			uni_modal("Trebuie să fi autentificat","login.php")
		}
		})
    </script>
